...
Genshin_path = 'Genshin'

def images_engine(filename):
    print(filename)

    if 'LG.jpg' in filename:
        path = os.path.join('Resource','picture','replica')
        file_list = os.listdir(path)

        file = file_list[random.randint(1,len(file_list))-1]
...
def switch_Genshin_path():
    global Genshin_path
    if Genshin_path == 'Genshin':
        Genshin_path = 'old_Genshin'

    elif Genshin_path =='old_Genshin':
        Genshin_path = 'Genshin'
...
def Open_Jpg(file):
    ...
    elif 'ZDCJ.jpg' in file:
        path = os.path.join('Resource', 'picture', 'fight')
        file_list = os.listdir(path)
    ...
    elif 'JUSE.jpg' in file:
        path = os.path.join('Resource', 'picture', 'altar')
        file_list = os.listdir(path)
    ...
    elif 'BYCT.jpg' in file or 'SHHJ.jpg' in file:
        path = os.path.join('Resource', 'picture', 'hall')
        file_list = os.listdir(path)
...
class 战斗场景():
    ...
    def 显示阵容窗口(self):
        ...
        if len(self.我方阵容) < 3 or len(self.我方阵容) == 2:
            self.p1 = self.我方阵容[0]
            self.p1_P = Open_Jpg(os.path.join('Resource', 'picture', Genshin_path, f'{self.p1.Code}-x.jpg'))
            ...
            if len(self.我方阵容) == 2:
                ...
                self.p2 = self.我方阵容[1]
                self.p2_P = Open_Jpg(os.path.join('Resource', 'picture', Genshin_path, f'{self.p2.Code}-x.jpg'))
            ...
            self.p3 = self.我方阵容[2]
            self.p3_P = Open_Jpg(os.path.join('Resource', 'picture', Genshin_path, f'{self.p3.Code}-x.jpg'))
            ...
            if len(self.我方阵容) == 4:
                '''判断一下是否为4,不是4则不渲染p4'''
                self.p4 = self.我方阵容[3]
                self.p4_P = Open_Jpg(os.path.join('Resource', 'picture', Genshin_path, f'{self.p4.Code}-x.jpg'))
            ...
            self.p5 = self.我方阵容[4]
            self.p5_P = Open_Jpg(os.path.join('Resource', 'picture', Genshin_path, f'{self.p5.Code}-x.jpg'))
        ...
        if len(self.敌方阵容) == 1:
            self.d1 = self.敌方阵容[0]
            self.d1_P = Open_Jpg(os.path.join('Resource', 'picture', Genshin_path, f'{self.d1.Code}-x.jpg'))
            ...
            self.d2 = self.敌方阵容[1]
            self.d2_P = Open_Jpg(os.path.join('Resource', 'picture', Genshin_path, f'{self.d2.Code}-x.jpg'))
            ...
            self.d3 = self.敌方阵容[2]
            self.d3_P = Open_Jpg(os.path.join('Resource', 'picture', Genshin_path, f'{self.d3.Code}-x.jpg'))
            ...
            self.d4 = self.敌方阵容[3]
            self.d4_P = Open_Jpg(os.path.join('Resource', 'picture', Genshin_path, f'{self.d4.Code}-x.jpg'))
            ...
            self.d5 = self.敌方阵容[4]
            self.d5_P = Open_Jpg(os.path.join('Resource', 'picture', Genshin_path, f'{self.d5.Code}-x.jpg'))
    ...
    def 战斗开始(self):
        ...
        # 初始化列表
            ...
            for i in self.出场阵容:
                ...
                colour = DE.fight_colour.get(i.伤害类型)
                if colour == None:
                    colour = 'black'
                ...
                line = self.create.create_line(i.c, D.c, arrow=LAST, width=4, fill=colour)
                self.line_list.append(line)
                C = self.伤害计算(i, D)
                伤害数值 = f'-{C}'
                坐标 = DE.Battlefield_service.字体坐标计算(D.c)
                伤害文本 = self.create.create_text(坐标, text=伤害数值, fill=colour, font=DE.战斗字体)
            ...
            for i in self.敌出场阵容:
                ...
                line = self.create.create_line(i.c, D.c, arrow=LAST, width=2, fill=colour)
                self.line_list.append(line)
                C = self.伤害计算(i, D)
                text = f'{i.name}攻击{D.name}\n造成{C}伤害。'
                self.战场动态.append(text)
...
class 元神信息卡片():
    def __init__(self, G, FM, x, y):
        self.G = G
        self.G_ICO_P = Open_Jpg(os.path.join('Resource', 'picture', Genshin_path, f'{self.G.Code}-c.jpg'))
    ...
    def 弹出信息(self, FM):
        ...
        # 立绘
        self.LH_P = Open_Jpg(os.path.join('Resource', 'picture', Genshin_path, f'{self.G.Code}-x.jpg'))  # 元神小立绘
...
class 阵容按钮():
    def __init__(self, G, FM, x, y):
        self.G = G
        self.ICO_P = Open_Jpg(os.path.join('Resource', 'picture', Genshin_path, f'{self.G.Code}-c.jpg'))
...
class 元神大图():
    def __init__(self, name, Code, PJ):
        ...
        self.P = Open_Jpg(os.path.join('Resource', 'picture', Genshin_path, f'{Code}-d.jpg'))
...
class 元神操作视图():
    ...
    def 创建操作按钮(self):
        ...
        def 鉴赏():
            self.GB_P = Open_Jpg(os.path.join('Resource', 'picture', Genshin_path, f'{self.G.Code}-d.jpg'))
            大图宽 = self.GB_P.width()
            if 大图宽 < 1366:
                放置位置 = (1366 - 大图宽) / 2
            else:
...
class 抽出按钮():  # 用于显示抽出的元神，临时用
    def __init__(self, root, Code):
        self.GB_P = Open_Jpg(os.path.join('Resource', 'picture', Genshin_path, f'{Code}-x.jpg'))
...
class Lineup():
    ...
    def 显示所有(self, 页码=1):
        ...
        for i in DE.Player_Mian.元神组[页码 * 36 - 36:页码 * 36]:
            # self.i = i
            # self.G_ICO_P = Open_Jpg(os.path.join('Resource','picture',Genshin_path,f'{i.Code}-c.jpg'))
    ...
    def 元神信息卡片(self, G):
        ...
        # self.宿敌_FM.config(bg='red')
        # 立绘
        self.LH_P = Open_Jpg(os.path.join('Resource', 'picture', Genshin_path, f'{G.Code}-x.jpg'))  # 元神小立绘
        self.LH = Label(self.元神_FM, image=self.LH_P)
        self.LH.place(x=5, y=0)
        # 装备图标
        if G.装备 == None:
...
class Genshin_But():
    ...
    def __init__(self, root, i, x, y):  # 创建时将提供放置坐标
        ...
        self.BUT_P = Open_Jpg(os.path.join('Resource', 'picture', Genshin_path, f'{self.G.Code}-c.jpg'))
...
class Call():  # 抽卡视图
    ...
    def 抽卡成功(self):
        ...
        self.GB_P = Open_Jpg(os.path.join('Resource', 'picture', Genshin_path, f'{G.Code}-d.jpg'))
        大图宽 = self.GB_P.width()
        if 大图宽 < 1366:
            放置位置 = (1366 - 大图宽) / 2
        else:
...
if __name__ == '__main__':
    ...
    Sys_menu.add_command(label='切换立绘风格', command=switch_Genshin_path)
